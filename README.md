# [SOLVED] Node-Js-What-Is-Enospc-Error-And-How-To-Solve
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/node-js-what-is-enospc-error-and-how-to-solve)
>
...
The ENOSPC error indicates that the disk space is full. Check if there's enough free space on the server and consider increasing it to resolve the issue.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/node-js-what-is-enospc-error-and-how-to-solve)**
